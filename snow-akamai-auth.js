...
AkamaiEdgeGridAuth.prototype = {
    ...
    _generateSignatureData: function(method, host, path, body, clientToken, accessToken, timestamp, nonce) {
    ...
    _generateAuthorizationHeader: function(clientToken, accessToken, timestamp, nonce, signature) {
